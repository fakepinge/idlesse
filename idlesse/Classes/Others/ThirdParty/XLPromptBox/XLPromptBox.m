...
#define kBackgroundColor [UIColor colorWithRed:0 green:0 blue:0 alpha:0.8]

static CGFloat const kDefaultWidth = 180.0f;
static CGFloat const kDefaultHeight = 20.0f;
static CGFloat const kDefaultRound = 5.0f;
static CGFloat const kDefaultTextFont = 13.0f;
static CGFloat const kDefaultMagin = 5.0f;
 ...
 */
- (CGRect)defaultFrame {
    return CGRectMake((kScreenWidth - kDefaultWidth) / 2.0f, kScreenHeight - kDefaultHeight - 64, kDefaultWidth, kDefaultHeight);
}
